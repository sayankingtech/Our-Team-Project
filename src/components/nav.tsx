...
const nav: React.FC = () => {
    return (
        <div className="grid grid-cols-12 h-22 w-[99%] justify-start items-center px-[px]">
            ...
            <div className='flex col-span-5 items-center p-2 w-135 rounded-[10px] bg-stone-200 border border-stone-400'>
            ...
            <div className='flex items-center col-span-3 place-content-around'>
